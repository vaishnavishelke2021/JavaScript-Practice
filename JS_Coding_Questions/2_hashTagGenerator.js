...
function generateHash(inputString) {
  if (inputString.length > 280 || inputString.trim().length === 0) return false;

  let words = inputString.split(" ");
  //   console.log(words);

  //   -------------------------------------------way 1------------------------------------------------
  //   let hashTag = words.map(
  //     (word) => word.replace(word.at(0), word.at(0).toUpperCase()) // or charAt
  //   );
  //   console.log(hashTag);

  //   -------------------------------------------way 2------------------------------------------------
  let hashTag = words.map((word) => word[0].toUpperCase() + word.slice(1));
